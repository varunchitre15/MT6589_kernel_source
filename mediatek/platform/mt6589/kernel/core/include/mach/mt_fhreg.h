...
#define OFFSET_FHCTL_2G1_CH          0x0030
#define OFFSET_FHCTL_2G2_CH          0x0034
#define OFFSET_FHCTL_INTMD_CH        0x0038
#define OFFSET_FHCTL_EXTMD_CH        0x003C
#define OFFSET_FHCTL_BT_CH           0x0040
#define OFFSET_FHCTL_WF_CH           0x0044
#define OFFSET_FHCTL_FM_CH           0x0048
#define OFFSET_FHCTL0_CFG	           0x004C
#define OFFSET_FHCTL0_UPDNLMT	       0x0050
#define OFFSET_FHCTL0_DDS	           0x0054
#define OFFSET_FHCTL0_MON	           0x0058
#define OFFSET_FHCTL1_CFG	           0x005C
#define OFFSET_FHCTL1_UPDNLMT	       0x0060
#define OFFSET_FHCTL1_DDS	           0x0064
#define OFFSET_FHCTL1_MON	           0x0068
#define OFFSET_FHCTL2_CFG	           0x006C
#define OFFSET_FHCTL2_UPDNLMT	       0x0070
#define OFFSET_FHCTL2_DDS	           0x0074
#define OFFSET_FHCTL2_MON	           0x0078
#define OFFSET_FHCTL3_CFG	           0x007C
#define OFFSET_FHCTL3_UPDNLMT	       0x0080
#define OFFSET_FHCTL3_DDS	           0x0084
#define OFFSET_FHCTL3_MON	           0x0088
#define OFFSET_FHCTL4_CFG	           0x008C
#define OFFSET_FHCTL4_UPDNLMT        0x0090
#define OFFSET_FHCTL4_DDS	           0x0094
#define OFFSET_FHCTL4_MON	           0x0098
#define OFFSET_FHCTL5_CFG	           0x009C
#define OFFSET_FHCTL5_UPDNLMT	       0x00A0
#define OFFSET_FHCTL5_DDS	           0x00A4
#define OFFSET_FHCTL5_MON            0x00A8
...
#define fh_read8(reg)           __raw_readb(reg)
#define fh_read16(reg)          __raw_readw(reg)
#define fh_read32(reg)          __raw_readl(reg)
