...
//<2013/06/30-26423-alberthsiao,[ATS00160169]Update camera parameters for imx111 to improve color shading
        {
        if( (i4DFIDX < TH3 && i4SceneLV < LV_Thres)||(i4CCT < 6100 && i4SceneLV <82))
        	eIdx_Shading_CCT_new =  eIDX_Shading_CCT_CWF;
        else
    ...
    case eIDX_Shading_CCT_CWF:
        ...
        {
        if( (i4DFIDX < TH3 && i4SceneLV < LV_Thres)||(i4CCT < 6300 && i4SceneLV <87))
        	eIdx_Shading_CCT_new =  eIDX_Shading_CCT_CWF;
        else
            eIdx_Shading_CCT_new = eIDX_Shading_CCT_RSVD;
        }
    ...
    if ( (eIdx_Shading_CCT_new == eIDX_Shading_CCT_D65) || (eIdx_Shading_CCT_new == eIDX_Shading_CCT_RSVD)){
        if( (i4DFIDX < TH3 && i4SceneLV < LV_Thres)||(i4CCT < 5600 && i4SceneLV <80)){
        	eIdx_Shading_CCT_new =  eIDX_Shading_CCT_CWF;
        }
    }
//>2013/06/30-26423-alberthsiao
