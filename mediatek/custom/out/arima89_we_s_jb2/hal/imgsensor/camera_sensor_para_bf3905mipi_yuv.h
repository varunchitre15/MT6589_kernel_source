#ifndef _CAMERA_SENSOR_PARA_BF3905_YUV_H
#define _CAMERA_SENSOR_PARA_BF3905_YUV_H
...
typedef enum
{
	...
	/* STRUCT: SENSOR */
#define BF3905MIPI_YUV_CAMERA_SENSOR_REG_DEFAULT_VALUE \
		/* ARRAY: SENSOR.reg[11] */\
		{\
			/* STRUCT: SENSOR.reg[0] */\
			{\
...
#define BF3905MIPI_YUV_CAMERA_SENSOR_CCT_DEFAULT_VALUE {{0x30a1,0x00},{0x3000,0x1B}}


#endif//#ifndef _CAMERA_SENSOR_PARA_BF3905_YUV_H
