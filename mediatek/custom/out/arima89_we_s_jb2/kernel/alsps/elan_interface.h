...
#define ELAN_EPL6881_IOCTL_GET_PFLAG _IOR(ELAN_IOCTL_MAGIC, 1, int *)
#define ELAN_EPL6881_IOCTL_GET_LFLAG _IOR(ELAN_IOCTL_MAGIC, 2, int *)
#define ELAN_EPL6881_IOCTL_ENABLE_PFLAG _IOW(ELAN_IOCTL_MAGIC, 3, int *)
#define ELAN_EPL6881_IOCTL_ENABLE_LFLAG _IOW(ELAN_IOCTL_MAGIC, 4, int *)
#define ELAN_EPL6881_IOCTL_GETDATA _IOR(ELAN_IOCTL_MAGIC, 5, int *)
...
void elan_ep16881_psensor_lock(int enable_pflag);	//EricHsieh,2012/10/29 ,add the wakelock for Psensor
