...
#if 1
    //  Video Size
//<2013/04/26-24377-alberthsiao, Add 320x240 video size for bf3905 camera
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
...
FTABLE_SCENE_DEP()
    //==========================================================================
//Begin_ATS00158433_Arima_HCSW7_20130422_JerryTai - SoMC camera parameters issue 20130510- CTS modify 
#if 1
    //  Focus Mode
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
...
#endif
//End_ATS00158433_Arima_HCSW7_20130422_JerryTai - SoMC camera parameters issue 20130510- CTS modify 
    //==========================================================================
#if 1
    //  ISO
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
