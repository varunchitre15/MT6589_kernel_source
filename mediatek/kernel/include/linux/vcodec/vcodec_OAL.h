...
#define VCODEC_OAL_VERSION 65890001
...
} VCODEC_OAL_CALLBACK_SMP_T;

extern VCODEC_OAL_CALLBACK_T rVCODEC_OAL_Function;
extern VCODEC_OAL_CALLBACK_SMP_T rVCODEC_OAL_Function_SMP;

int VCodecOALInit(IN VCODEC_OAL_CALLBACK_T *prVCODEC_OAL_Function);
int VCodecOALInitSMP(IN VCODEC_OAL_CALLBACK_SMP_T *prVCODEC_OAL_Function_SMP);
