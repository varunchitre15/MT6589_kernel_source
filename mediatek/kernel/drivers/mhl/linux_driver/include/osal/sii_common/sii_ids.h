...
typedef enum
{
    ...
    SII_STATUS_WARN_PENDING           = SII_STATUS_VALUE(SII_GROUP_GENERAL, SII_STATUS_LEVEL_WARNING, 0x01),   
    SII_STATUS_WARN_BREAK             = SII_STATUS_VALUE(SII_GROUP_GENERAL, SII_STATUS_LEVEL_WARNING, 0x02),   
    SII_STATUS_WARN_INCOMPLETE        = SII_STATUS_VALUE(SII_GROUP_GENERAL, SII_STATUS_LEVEL_WARNING, 0x03),   
    SII_STATUS_WARN_CUSTOM1           = SII_STATUS_VALUE(SII_GROUP_GENERAL, SII_STATUS_LEVEL_WARNING, 0x81),   
    SII_STATUS_WARN_CUSTOM2           = SII_STATUS_VALUE(SII_GROUP_GENERAL, SII_STATUS_LEVEL_WARNING, 0x82),   
    SII_STATUS_WARN_CUSTOM3           = SII_STATUS_VALUE(SII_GROUP_GENERAL, SII_STATUS_LEVEL_WARNING, 0x83),   
    SII_STATUS_WARN_CUSTOM4           = SII_STATUS_VALUE(SII_GROUP_GENERAL, SII_STATUS_LEVEL_WARNING, 0x84),   
    SII_STATUS_WARN_CUSTOM5           = SII_STATUS_VALUE(SII_GROUP_GENERAL, SII_STATUS_LEVEL_WARNING, 0x85),   
    SII_STATUS_WARN_LAST,
    SII_STATUS_ERR_INVALID_HANDLE     = SII_STATUS_VALUE(SII_GROUP_GENERAL, SII_STATUS_LEVEL_ERROR, 0x00),  
    SII_STATUS_ERR_INVALID_PARAM      = SII_STATUS_VALUE(SII_GROUP_GENERAL, SII_STATUS_LEVEL_ERROR, 0x01),  
    SII_STATUS_ERR_INVALID_OP         = SII_STATUS_VALUE(SII_GROUP_GENERAL, SII_STATUS_LEVEL_ERROR, 0x02),  
    SII_STATUS_ERR_NOT_AVAIL          = SII_STATUS_VALUE(SII_GROUP_GENERAL, SII_STATUS_LEVEL_ERROR, 0x03),  
    ...
    SII_STATUS_ERR_NOT_IMPLEMENTED    = SII_STATUS_VALUE(SII_GROUP_GENERAL, SII_STATUS_LEVEL_ERROR, 0x41),  
