...
enum dlmalloc_function {
	...
	action_mspace_footprint_limit,
	action_mspace_set_footprint_limit,
	action_mspace_mallinfo,
	action_mspace_walk_free_pages,
	action_mspace_walk_heap,
	action_mspace_realloc_in_place,
	action_mmap_resize,
	action_dlindependent_calloc,
	action_dlindependent_comalloc,
	action_init_user_mstate,
	action_dispose_chunk,
	action_try_realloc_chunk,
	action_realloc_in_place,
	action_internal_bulk_free,
	action_mspace_max_footprint,
	action_internal_inspect_all,
	action_function_max
};
...
typedef struct ChunkDebug_Info *chunk_DebugPtr;
#endif
