...
#include <linux/proc_fs.h>	//EricHsieh,2013/5/13, add the wakelock source to proce/wakelocks
				     ...
				     struct wakeup_source *ws)
{
	...
	//<<EricHsieh,2013/5/13, Fixed the battery dump tool can show correctly.
...
static int __init wakeup_sources_debugfs_init(void)
{
	...
	//<<EricHsieh,2013/5/13, add the wakelock sources to /proc/wakelocks
